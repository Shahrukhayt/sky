...
class Rm_HubSpot_LeadNurturing extends Rm_HubSpot_BaseClient {
    ...
    **/
    public function get_campaigns($excludeInactive) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to retrieve campaigns: ' . $e);
        }
    }
    ...
    **/
    public function get_campaign_members($campaignGuid) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to retrieve campaign members: ' . $e);
        }
    }
    ...
    **/
    public function get_campaign_history($leadGuid) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to retrieve campaign history: ' . $e);
        }
    }
    ...
    **/
    public function enroll_lead_in_campaign($campaignGuid, $leadGuid) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to add lead to campaign: ' . $e);
        }
    }
    ...
    **/
    public function remove_lead_from_campaign($campaignGuid, $leadGuid) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to remove lead to campaign: ' . $e);
        }
    }
