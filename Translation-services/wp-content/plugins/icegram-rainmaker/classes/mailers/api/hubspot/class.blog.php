...
class Rm_HubSpot_Blog extends Rm_HubSpot_BaseClient {
    ...
    public function get_blogs($params, $content_type) {
        ...
        if ($content_type == 'json') {
            try {
                ...
                throw new Rm_HubSpot_Exception('Unable to retrieve blogs: ' . $e);
            }
            ...
            throw new Rm_HubSpot_Exception('Invalid content type, please choose either "json" or "atom"');
        }
    }
    ...
    **/
    public function create_post($blog_guid, $author_name, $author_email, $title, $summary, $post_content, $tags) {
        ...
        if ($this->isBlank($title)) {
            throw new Rm_HubSpot_Exception('Blog title is required!');
        } else if ($this->isBlank($post_content)) {
            throw new Rm_HubSpot_Exception('Blog content is required!');
        } else if ($this->isBlank($author_email)) {
            throw new Rm_HubSpot_Exception('Author email is required!');
        }
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to add blog post: ' . $e);
        }
    }
    ...
    **/
    public function update_post($post_guid, $title, $summary, $post_content, $tags, $meta_desc, $keywords) {
        ...
        if ($this->isBlank($post_guid)) {
            throw new Rm_HubSpot_Exception('Post guid is required!');
        }
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to update blog post: ' . $e);
        }
    }
    ...
    **/
    public function publish_post($post_guid, $publish_time, $should_notify) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to publish blog post: ' . $e);
        }
    }
