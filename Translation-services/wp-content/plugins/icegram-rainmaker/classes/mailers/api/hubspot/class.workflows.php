...
class Rm_HubSpot_Workflows extends Rm_HubSpot_BaseClient{
	...
	**/
	public function get_all_workflows(){
		...
		try{
			...
			throw new Rm_HubSpot_Exception('Unable to get workflows: '.$e);
		}
	}
	...
	**/
	public function get_workflow_by_ID($id){
		...
		try{
			...
			throw new Rm_HubSpot_Exception('Unable to get workflow: '.$e);
		}
	}
	...
	**/
	public function get_current_enrollments($vid){
		...
		try{
			...
			throw new Rm_HubSpot_Exception('Unable get enrollments for contact: '.$e);
		}
	}
	...
	**/
	public function get_log_events($wfID, $vid, $params){
		...
		try{
			...
			throw new Rm_HubSpot_Exception('Unable get log events for contact: '.$e);
		}
	}	
	...
	**/
	public function get_upcoming_events($wfID, $vid, $params){
		...
		try{
			...
			throw new Rm_HubSpot_Exception('Unable get upcoming events for contact: '.$e);
		}
	}
