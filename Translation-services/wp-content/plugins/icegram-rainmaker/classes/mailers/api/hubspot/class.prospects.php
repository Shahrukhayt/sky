...
class Rm_HubSpot_Prospects extends Rm_HubSpot_BaseClient {
    ...
    **/
    public function get_timeline($params) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to retrieve timeline: ' . $e);
        }
    }
    ...
    **/
    public function get_organization_details($organization) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to retrieve organization details: ' . $e);
        }
    }
    ...
    **/
    public function get_typeahead($query) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to retrieve typeahead information: ' . $e);
        }
    }
    ...
    **/
    public function get_search_results($type, $query) {
        if (($type != 'city')&&($type!='region')&&($type!='country')) {
            throw new Rm_HubSpot_Exception('Invalid type: ' . $type . ' Type must be equal to city, region, or country');
        }
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to retrieve search results: ' . $e);
        }
    }
    ...
    **/
    public function get_filters() {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to retrieve filters: ' . $e);
        }
    }
    ...
    **/
    public function add_filter($organization) {
        ...
        if ($this->isBlank($organization)) {
            throw new Rm_HubSpot_Exception('Organization is required');
        }
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to add filter: ' . $e);
        }
    }
    ...
    **/
    public function delete_filter($organization) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to delete filter: ' . $e);
        }
    }
