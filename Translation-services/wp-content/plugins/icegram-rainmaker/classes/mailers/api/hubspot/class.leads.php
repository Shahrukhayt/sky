...
class Rm_HubSpot_Leads extends Rm_HubSpot_BaseClient {
    ...
    **/
    public function get_leads($params) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to retrieve list: ' . $e);
        }
    ...
    **/
    public function get_lead($leadGuid) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to retrieve lead: ' . $e);
        }
    }
    ...
    **/
    public function update_lead($leadGuid, $updateData) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to update lead: ' . $e);
        }
    }
    ...
    **/
    public function close_lead($leadGuid, $closeDate) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to close lead: ' . $e);
        }
    }
    ...
    **/
    public function add_lead($formURL, $postFields) {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to add lead: ' . $e);
        }
    }
    ...
    **/
    public function get_webhooks() {
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to retrieve webhooks: ' . $e);
        }
    }
    ...
    **/
    public function register_webhook($callbackURL) {
        ...
        if ($this->isBlank($callbackURL)) {
            throw new Rm_HubSpot_Exception('callbackURL is required');
        }
        ...
        try {
            ...
            throw new Rm_HubSpot_Exception('Unable to register webhook: ' . $e);
        }
    }
    ...
    **/
    public function delete_webhook($webhookGuid) {
        if ($this->isBlank($webhookGuid)) {
            throw new Rm_HubSpot_Exception('callbackGuid is required');
        }
        $endpoint = 'callback-url/' . $webhookGuid;
        try {
            return $this->execute_delete_request($this->get_request_url($endpoint,null), null);
        } catch (Rm_HubSpot_Exception $e) {
            throw new Rm_HubSpot_Exception('Unable to delete webhook: ' . $e);
        }
    }
