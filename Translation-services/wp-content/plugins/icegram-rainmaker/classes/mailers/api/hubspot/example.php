...
/*
//Exercise Blog API
    $blogs = new Rm_HubSpot_Blog($HAPIKey);
    $content_type = 'json';
...
//Exercise Leads API
    $leads = new Rm_HubSpot_Leads($HAPIKey);
...
//Exercise Settings API
    $settings = new Rm_HubSpot_Settings($HAPIKey);
...
//Exercise Marketing Events API
    $events = new Rm_HubSpot_Events($HAPIKey);
...
//Exercise Lead Nurturing API
    $nurture = new Rm_HubSpot_LeadNurturing($HAPIKey);
...
//Exercise Prospects API
    $prospects = new Rm_HubSpot_Prospects($HAPIKey);
...
//Exercise Keywords API
    $keywords = new Rm_HubSpot_Keywords($HAPIKey);
...
/*    $contacts = new Rm_HubSpot_Contacts($HAPIKey);
    ...
    //Exercise Workflows API
        $workflows = new Rm_HubSpot_Workflows($HAPIKey);
    ...
    //Exercise Forms API
        $forms = new Rm_HubSpot_Forms($HAPIKey);
        $uid = uniqid();
    ...
    //Exercise Lists API
        $lists = new Rm_HubSpot_Lists($HAPIKey);
    ...
    //Exercise Properties API
        $properties = new Rm_HubSpot_Properties($HAPIKey);
...
*/
    //Exercise Social Media API
        $social = new Rm_HubSpot_SocialMedia($HAPIKey);
