...
if ( ! function_exists( "Rm_REST_SERIALISATION_get_available" ) ) {
	function Rm_REST_SERIALISATION_get_available( $log ) {
		$log->log_message( 'Getting serialiser', __FUNCTION__, Rm_REST_LOG_VERBOSE );
		if ( function_exists( 'json_decode' ) && function_exists( 'json_encode' ) ) {
			return new Rm_REST_NativeJsonSerialiser( $log );
		} else {
			return new Rm_REST_ServicesJsonSerialiser( $log );
		}
	}
}

if ( ! class_exists( 'Rm_REST_BaseSerialiser' ) ) {
	class Rm_REST_BaseSerialiser {
...
if ( ! class_exists( 'Rm_REST_DoNothingSerialiser' ) ) {
	class Rm_REST_DoNothingSerialiser extends Rm_REST_BaseSerialiser {
		function get_type() {
			return 'do_nothing';
		}
...
if ( ! class_exists( 'Rm_REST_NativeJsonSerialiser' ) ) {
	class Rm_REST_NativeJsonSerialiser extends Rm_REST_BaseSerialiser {
...
if ( ! class_exists( 'Rm_REST_ServicesJsonSerialiser' ) ) {
	class Rm_REST_ServicesJsonSerialiser extends Rm_REST_BaseSerialiser {
