 ...
 *
 */
if ( ! class_exists( 'Rm_REST_General' ) ) {
	class Rm_REST_General extends Rm_REST_Wrapper_Base {
		 ...
		 *
		 * @return Rm_REST_Wrapper_Result A successful response will be an object of the form
		 * {
		...
		public static function exchange_token(
			...
			return $wrap->post_request( Rm_OAUTH_TOKEN_URI, $body, $options );
		}
		...
		function Rm_REST_Wrapper_Base(
			...
			$this->Rm_REST_Wrapper_Base( $auth_details, $protocol, $debug_level, $host, $log, $serialiser, $transport );
		}
		 ...
		 * @return Rm_REST_Wrapper_Result a successful response will be an array in the form:
		 ...
		 *
		 * @return Rm_REST_Wrapper_Result A successful response will be an array of the form:
