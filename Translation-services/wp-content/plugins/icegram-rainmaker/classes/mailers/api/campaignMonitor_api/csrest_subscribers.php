 ...
 *
 */
if ( ! class_exists( 'Rm_REST_Subscribers' ) ) {
	class Rm_REST_Subscribers extends Rm_REST_Wrapper_Base {
		 ...
		 * @param int $debug_level The level of debugging required Rm_REST_LOG_NONE | Rm_REST_LOG_ERROR | Rm_REST_LOG_WARNING | Rm_REST_LOG_VERBOSE
		 * @param string $host The host to send API requests to. There is no need to change this
		 * @param Rm_REST_Log $log The logger to use. Used for dependency injection
