 ...
 *
 */
if ( ! class_exists( 'Rm_REST_Clients' ) ) {
	class Rm_REST_Clients extends Rm_REST_Wrapper_Base {
		 ...
		 * @access public
		 * @return Rm_REST_Wrapper_Result A successful response will be empty
		 */
		function delete() {
		 ...
		 *
		 * @access public
		 * @return Rm_REST_Wrapper_Result A successful response will be the ID of the newly created client
		 */
		 ...
		 *
		 * @access public
		 * @return Rm_REST_Wrapper_Result A successful response will be an object
		 * of the form:
		 * {
