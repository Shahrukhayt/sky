	...
	class Rainmaker {
		...
		public function rm_dismiss_admin_notice() {
			if ( isset( $_GET['rm_dismiss_admin_notice'] ) && $_GET['rm_dismiss_admin_notice'] == '1' && isset( $_GET['rm_option_name'] ) ) {
				...
				if ( 'rm_offer_bfcm_2020' === $option_name ) {
					$url = "https://www.icegram.com/rainmaker-pricing-table/?utm_source=in_app&utm_medium=rm_banner&utm_campaign=offer_bfcm_2020";
					header( "Location: {$url}" );
					exit();
				} else {
